 ...
 * shipping-relateddetails for an item (pre-checkout) or order 
 * (post-checkout).<br/><br/> <span class="tablenote"> <strong>IMPORTANT:</strong> 
 * To avoid loss of shipping details when revising a listing, you must include all 
 * <strong>ShippingDetails</strong> fields that were originally provided. Do not 
 * omit any tag, even if its value does not change. Omitting a shipping field when 
 * revising an item will remove that detail from the listing. </span> 
 *
