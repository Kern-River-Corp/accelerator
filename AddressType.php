...
/**
 * Contains the data for an eBay user's address. This is the base type for a number 
 * of user addresses, including seller payment address, buyer shipping address and 
