...
/**
 * This enumeration type contains a list of standard 3-digit ISO 4217 currency 
 * codes for currency used in countries around the world.<br/><br/>When adding an 
 * item through <b>AddItem</b> (or related API call), the <b>Item.Currency</b> 
 * value will default to the currency used on the listingsite. Otherwise, only the 
 * following currency types may be specified through an Add/Revise/Relist call, 
 * since these are the currencies of all the countries where the Trading API is 
 * supported:<ul><li>USD - US Dollar</li><li>CAD - Canadian Dollar</li><li>GBP - 
 * British Pound</li><li>AUD - Australian Dollar</li><li>EUR - Euro</li><li>CHF - 
 * Swiss Franc</li><li>CNY - Chinese Renminbi</li><li>HKD - Hong Kong 
 * Dollar</li><li>PHP - Philippines Peso</li><li>PLN - Polish Zloty</li><li>SEK - 
 * Sweden Krona</li><li>SGD - Singapore Dollar</li><li>TWD - Taiwanese 
 * Dollar</li><li>INR - Indian Rupee</li><li>MYR - Malaysian 
 * Ringgit</li></ul><br/>Other currency codes in this enumerated type may be 
 * returned in<b>GetItem</b> (and other calls) based on the buyer's and/or 
 * seller'sregistration country. However, only the values listed above will be 
 * returned if you call <b>GeteBayDetails</b> with <b>DetailName</b> set to 
 * <b>CurrencyDetails</b>. http://www.xe.com/iso4217.htm 
 *
