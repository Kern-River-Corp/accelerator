 ...
 * @property string ISBNIdentifierEnabled
 * @property string UPCIdentifierEnabled
 * @property string EANIdentifierEnabled
 * @property string BrandMPNIdentifierEnabled
 ...
 * @property string CompatibilityEnabled
 * @property string MinCompatibleApplications
 * @property string MaxCompatibleApplications
 * @property string ConditionEnabled
 * @property string ConditionValues
 * @property string ValueCategory
 * @property string ProductCreationEnabled
 * @property string MaxGranularFitmentCount
 * @property string CompatibleVehicleType
 * @property string PaymentOptionsGroup
 * @property string ShippingProfileCategoryGroup
 * @property string PaymentProfileCategoryGroup
 * @property string ReturnPolicyProfileCategoryGroup
 * @property string VINSupported
 * @property string VRMSupported
 * @property string SellerProvidedTitleSupported
 * @property string DepositSupported
 * @property string GlobalShippingEnabled
 * @property string AdditionalCompatibilityEnabled
 */
