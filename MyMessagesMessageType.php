...
/**
 * Container for the message information for each message specified inMessageIDs. 
 * The amount and type of information returned varies based onthe requested detail 
 * level. 
 *
