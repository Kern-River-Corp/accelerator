...
{ 
...

	{
		...
		if(!array_key_exists('LOG_TIMEPOINTS', $this->_loggingOptions))
...

	{
		...
		if(!array_key_exists('LOG_API_USAGE', $this->_loggingOptions))
...

	{
		...
		if (array_key_exists('HTTP_VERBOSE', $this->_transportOptions) and $this->_transportOptions['HTTP_VERBOSE'])
