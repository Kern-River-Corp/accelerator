 ...
 * seller to set buyer requirements at the listing level. For the corresponding 
 * listing, all buyer requirement values/settings will overwrite values/settings in 
 * Buyer Requirements preferences in My eBay. 
 *
