...
/**
 * Creates a new Second Chance Offer (that is, an offer for an unsold item) for one 
 * of that item's non-winning bidders. 
 *
 * @link http://developer.ebay.com/DevZone/XML/docs/Reference/eBay/types/AddSecondChanceItemRequestType.html
 *
 */
