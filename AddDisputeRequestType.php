 ...
 * cancel a single line item order. <br/><br/><span 
 * class="tablenote"><b>Note:</b>This call is only used by sellers to create an 
 * Unpaid Item case or to mutually cancel a single line item order. Buyers must use 
 * the eBay Resolution Center or PayPal Resolution Center (for orders that satisfy 
 * requirements) to create an Item Not Received or an Item Significantly Not as 
 * Described case. </span> 
 *
