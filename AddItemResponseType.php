 ...
 * the estimated fees for the new listing (except the Final Value Fee, which isn't 
 * calculated until the item has sold), the start and end times of the listing, and 
 * other details. 
 *
 * @link http://developer.ebay.com/DevZone/XML/docs/Reference/eBay/types/AddItemResponseType.html
 *
 */
