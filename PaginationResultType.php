...
/**
 * Shows the pagination of data returned by call requests.Pagination of returned 
 * data is not needed norsupported for every Trading API call. See the 
 * documentation forindividual calls to determine whether pagination issupported, 
