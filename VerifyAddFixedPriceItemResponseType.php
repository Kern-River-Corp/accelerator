...
/**
 * Returns the listing recommendations (if applicable), theestimated fees for the 
 * proposed new listing (except the Final Value Fee, which isn't calculateduntil 
 * the item has sold), and other details. 
 *
