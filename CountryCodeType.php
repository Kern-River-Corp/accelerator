 ...
 * code (e.g., KY="Cayman Islands"), call <b>GeteBayDetails</b> with 
 * <b>DetailName</b> set to <b>Country</b>.<br><br>Most of the codes that eBay uses 
 * conform to the ISO 3166 standard, but some of thecodes in the ISO 3166 standard 
 * are not used by eBay. Plus, there are some non-ISOcodes in the eBay list. 
 * (Additional codes appear at the end of this code list andare noted as non-ISO.) 
 *
