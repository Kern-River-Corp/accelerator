...
/**
 * Type defining the Feedback details for an order line item, including the eBay 
 * User IDof the user the feedback is intended for, the Feedback rating, and the 
 * Feedback comment. 
 *
