 ...
 * theseller must specify at least one domestic shipping service as well.<br/><br/> 
 * <span class="tablenote"> <strong>Note:</strong> For GetItemTransactions and 
 * GetSellerTransactions, this container does not return accurate shipping service 
 * and cost information for multiple line item orders. Use GetOrders instead, and 
 * provide the order's combined <strong>OrderID</strong> to retrieve this 
 * information. </span> 
 *
