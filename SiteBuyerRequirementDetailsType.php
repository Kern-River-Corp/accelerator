...
/**
 * Type defining the <b>BuyerRequirementDetails</b> container, which is returned 
 * inGeteBayDetails, and provides the seller with the buyer requirement features 
 * (and applicablevalues) that are supported by the listing site.<br/><br/><span 
 * class="tablenote"><b>Note: </b>This container is only returned if 
 * <b>BuyerRequirementDetails</b> is included as a <b>DetailName</b> filter in the 
