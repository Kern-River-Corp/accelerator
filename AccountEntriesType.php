 ...
 * Contains one AccountEntry object for each account entry returned. See the 
 * schema documentation for AccountEntryType for details on its properties. You can 
 * uniquely identify the entries that the GetAccount call returns within the 
