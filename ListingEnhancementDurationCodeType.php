 ...
 * to setthe duration of a Featured Gallery in a fixed-price listing. Once set for 
 * a listing, theFeatured Gallery duration can be increased from 'Days_7' to 
 * 'Lifetime' (throughout life of listing), but the duration cannot be decreased 
 * from 'Lifetime' to 'Days_7'. 
 *
